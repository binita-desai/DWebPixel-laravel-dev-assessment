                            ...
                            @foreach ($jobs as $job)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3 text-center">
                                        <img src="{{ $job['company_logo_url'] }}" class="h-12 w-auto block mx-auto" alt="{{ $job['company_name'] }}">
                                    </td>
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        <button wire:confirm="Are you sure you want to delete this record?" wire:click="delete({{$job['id']}})" class="text-sm px-3 py-1.5 rounded hover:bg-slate-100 transition-colors text-red-500">Delete</button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
